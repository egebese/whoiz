...
### Changed
- General improvements and link routing tweaks. Registered-domain output now
  surfaces a "Transfer to Spaceship" link alongside the existing "Watch /
  register on drop" link.
...
[0.3.1]: https://github.com/egebese/whoiz/releases/tag/v0.3.1
